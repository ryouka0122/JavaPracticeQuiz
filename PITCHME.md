...
### ☆２１
[ファイル操作]－☆１１のプログラムを改修し，次の機能を実装したReaderを作成してください．  
...
### ☆２２
☆２１で実装したクラスと同様に，tsvファイルを扱うTsvFileReaderを実装してください．  

---

### ☆２３
☆２１と☆２２で実装したCsvFileReaderとTsvFileReaderは区切り文字だけ違うだけで挙動は同じ為，両方のファイルを扱うことが出来るDataFileReaderクラスを作成してください．

---

### ☆２４
☆２１，２２，２３でそれぞれ作成したクラスを下のページのようなクラス構成に修正して，想定ソースコードが書けるように実装ください．  
